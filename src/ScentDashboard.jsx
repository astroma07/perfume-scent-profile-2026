...
const FRAGRANCE_DB = [
  /* ── Sonnet recommendations from your chat ── */
  { name: "Bal d'Afrique", house: "Byredo", cost: 290, ml: 100, notes: ["vetiver","musk","bergamot","african marigold","cedar"], description: "Earthy, green, and luminous — the DNA of Ceremonia Perfume de la Tierra." },
  { name: "Burning Barbershop", house: "D.S. & Durga", cost: 195, ml: 50, notes: ["smoke","leather","birch tar","sage"], description: "Dark and earthy like Nosferatu but smokier — a struck-match opening into charred wood." },
  { name: "Timbuktu", house: "L'Artisan Parfumeur", cost: 170, ml: 100, notes: ["mango wood","myrrh","cardamom","incense"], description: "Earthy-spicy-resinous, very much in line with your Diptyque taste." },
  { name: "Wonderwood", house: "Comme des Garçons", cost: 130, ml: 100, notes: ["cedar","sandalwood","vetiver","oud"], description: "A pure woody cedar experience — stripped down and clean-dark." },
  { name: "MAAI", house: "Bogue Profumo", cost: 250, ml: 50, notes: ["labdanum","myrrh","leather","sandalwood"], description: "One of the most revered dark resins — squarely your territory." },
  { name: "Tam Dao", house: "Diptyque", cost: 180, ml: 75, notes: ["sandalwood","cedar","rosewood","cypress"], description: "A classic sandalwood pillar from Diptyque — creamy, warm, meditative." },
  { name: "The Lover's Tale", house: "Francesca Bianchi", cost: 185, ml: 30, notes: ["tobacco","benzoin","suede","earth","musk"], description: "Compatible with Rock the Myrrh and Jazz Club — dark comfort." },
  { name: "Whispers in the Library", house: "Maison Martin Margiela", cost: 140, ml: 100, notes: ["cedar","vanilla","tonka","musk","amber"], description: "Goes deeper into vanilla-wood territory than By the Fireplace." },
  /* ── Popular Diptyque ── */
  ...
  { name: "Fleur de Peau", house: "Diptyque", cost: 200, ml: 75, notes: ["musk","iris","ambrette","magnolia"], description: "Skin-scent intimacy — Diptyque's most sensual offering." },
  ...
  /* ── Dries Van Noten extended ── */
  { name: "Jardin de l'Orangerie", house: "Dries Van Noten", cost: 250, ml: 100, notes: ["orange blossom","sandalwood","vanilla","amber"], description: "Luminous orange flower grounded by warm woods — DVN's softer side." },
  ...
  { name: "English Pear & Freesia", house: "Jo Malone", cost: 78, ml: 30, notes: ["pear","freesia","patchouli","amber"], description: "Crisp and bright — an easy-wearing counterpoint to your darker bottles." },
  { name: "Oud & Bergamot", house: "Jo Malone", cost: 150, ml: 50, notes: ["oud","bergamot","cedar","amber"], description: "Jo Malone's niche-leaning oud — smoky citrus warmth." },
  /* ── Tom Ford ── */
  ...
  { name: "Tuscan Leather", house: "Tom Ford", cost: 285, ml: 50, notes: ["leather","raspberry","saffron","amber"], description: "Animalic leather with a sweet-fruity opening — polarizing and magnificent." },
  /* ── Le Labo ── */
  ...
  { name: "Another 13", house: "Le Labo", cost: 310, ml: 100, notes: ["ambrette","musk","moss","jasmine"], description: "A skin scent that smells like you but better — musky, clean, magnetic." },
  ...
  /* ── Byredo ── */
  { name: "Gypsy Water", house: "Byredo", cost: 290, ml: 100, notes: ["bergamot","pine","sandalwood","vanilla","amber"], description: "Fresh woods and campfire nostalgia — one of Byredo's best." },
  { name: "Mojave Ghost", house: "Byredo", cost: 290, ml: 100, notes: ["ambrette","sandalwood","violet","magnolia","cedar"], description: "Desert blooms and ghostly woods — ethereal and lasting." },
  { name: "Black Saffron", house: "Byredo", cost: 290, ml: 100, notes: ["saffron","leather","raspberry","vetiver","cedar"], description: "Spiced leather with berry tartness — dark and intriguing." },
  /* ── Creed ── */
  { name: "Aventus", house: "Creed", cost: 445, ml: 100, notes: ["pineapple","birch","musk","ambergris","vanilla"], description: "The king of crowd-pleasers — smoky fruit, birch, and power." },
  ...
  { name: "Royal Oud", house: "Creed", cost: 445, ml: 100, notes: ["oud","cedar","sandalwood","galbanum","pink pepper"], description: "Creed's refined take on oud — woody, peppery, regal." },
  ...
  { name: "Autumn Vibes", house: "Maison Martin Margiela", cost: 140, ml: 100, notes: ["cedar","nutmeg","patchouli","cardamom"], description: "Spiced woods and leaf piles — fall captured in a bottle." },
  /* ── Niche / Indie ── */
  { name: "Baccarat Rouge 540", house: "Maison Francis Kurkdjian", cost: 325, ml: 70, notes: ["saffron","ambergris","cedar","jasmine"], description: "Crystalline sweetness — the fragrance that launched a thousand dupes." },
  ...
  { name: "Pegasus", house: "Parfums de Marly", cost: 325, ml: 125, notes: ["almond","vanilla","sandalwood","amber","heliotrope"], description: "Sweet, almond-forward warmth — crowd-pleasing niche." },
  { name: "Layton", house: "Parfums de Marly", cost: 325, ml: 125, notes: ["apple","vanilla","cardamom","sandalwood","guaiac wood"], description: "Spiced apple and creamy woods — one of the most-complimented fragrances." },
  ...
  { name: "Hacivat", house: "Nishane", cost: 210, ml: 100, notes: ["pineapple","bergamot","patchouli","cedar","oakmoss"], description: "The Aventus alternative — fruity, woody, and long-lasting at a better price." },
  ...
  { name: "Reflection Man", house: "Amouage", cost: 310, ml: 100, notes: ["rosemary","neroli","sandalwood","cedar","jasmine"], description: "Elegant, clean, and refined — Amouage's most versatile." },
];
...
export default function ScentDashboard() {
  ...
  const [analyzing, setAnalyzing] = useState(() => {
    // Skip auto-analysis if we already have a Sonnet-generated profile saved
    return loadStored("notesSource", "fallback") === "sonnet" ? false : true;
  });
  ...
  useEffect(() => {
    ...
    // Only call Sonnet if we don't have a saved profile
