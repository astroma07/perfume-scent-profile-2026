...
export const STATUS_COLORS = { "owned": "#7a927a", "had": "#8a7e6b", "tried it": "#a09070", "wishlist": "#c5a46d", "to test": "#7a5073" };
export const TESTER_COLOR = "#5a7a9a";
export const STATUSES = ["owned", "had", "tried it", "wishlist", "to test"];
