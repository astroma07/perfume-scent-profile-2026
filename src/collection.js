...
export const INITIAL_BOTTLES = [
  ...
  { name: "Voodoo Chile",        fullName: "Voodoo Chile — Dries Van Noten",           house: "Dries Van Noten",           cost: 250, ml: 100, freq: 0, status: "wishlist" },
  { name: "Casa Blanca",         fullName: "Casa Blanca — House of Bo",                house: "House of Bo",               cost: 185, ml: 50,  freq: 0, status: "wishlist" },
  { name: "Philosykos",          fullName: "Philosykos — Diptyque",                    house: "Diptyque",                  cost: 180, ml: 75,  freq: 0, status: "wishlist" },
  { name: "Frustration",         fullName: "Etat Libre d'Orange Frustration",          house: "Etat Libre d'Orange",       cost: 155, ml: 50,  freq: 0, status: "wishlist" },
  { name: "French Leather",      fullName: "Memo Paris French Leather",                house: "Memo Paris",                cost: 295, ml: 75,  freq: 0, status: "wishlist" },
  { name: "Eau Capitale",        fullName: "Eau Capitale — Diptyque",                  house: "Diptyque",                  cost: 180, ml: 75,  freq: 0, status: "wishlist" },
  { name: "Camomile Satin",      fullName: "Camomile Satin — Dries Van Noten",         house: "Dries Van Noten",           cost: 250, ml: 100, freq: 0, status: "wishlist" },
  { name: "Fleur Du Mal",        fullName: "Fleur Du Mal — Dries Van Noten",           house: "Dries Van Noten",           cost: 250, ml: 100, freq: 0, status: "wishlist" },
  { name: "Jazz Club",           fullName: "Jazz Club — Maison Martin Margiela",       house: "Maison Martin Margiela",    cost: 140, ml: 100, freq: 0, status: "wishlist" },
  { name: "By the Fireplace",    fullName: "By the Fireplace — Maison Martin Margiela",house: "Maison Martin Margiela",    cost: 140, ml: 100, freq: 0, status: "wishlist" },
  { name: "Crazy Basil",         fullName: "Crazy Basil — Dries Van Noten",            house: "Dries Van Noten",           cost: 250, ml: 100, freq: 0, status: "wishlist" },
  { name: "Guilty Story",        fullName: "Guilty Story — Mihan Aromatics",           house: "Mihan Aromatics",           cost: 200, ml: 50,  freq: 0, status: "to test" },
  { name: "Ave Maria",           fullName: "Ave Maria — House of Bo",                  house: "House of Bo",               cost: 185, ml: 50,  freq: 0, status: "to test" },
  { name: "Rosario",             fullName: "Rosario — House of Bo",                    house: "House of Bo",               cost: 185, ml: 50,  freq: 0, status: "to test" },
  { name: "Poets of Berlin",     fullName: "Poets of Berlin — Vilhelm Parfumerie",     house: "Vilhelm Parfumerie",        cost: 245, ml: 100, freq: 0, status: "to test" },
  { name: "Myrrh and Tonka",     fullName: "Myrrh and Tonka — Jo Malone",              house: "Jo Malone",                 cost: 78,  ml: 50,  freq: 0, status: "to test" },
  { name: "Velvet Rose & Oud",   fullName: "Velvet Rose and Oud — Jo Malone",          house: "Jo Malone",                 cost: 150, ml: 50,  freq: 0, status: "to test" },
  { name: "Orpheon",             fullName: "Orpheon — Diptyque",                       house: "Diptyque",                  cost: 180, ml: 75,  freq: 0, status: "to test" },
];
